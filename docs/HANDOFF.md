...
- **State:** 276 tests passing (154 subset-lib + 70 vc + 46 integration + 6 driver-bin),
...
| Lane | Status |
|---|---|
| `cargo +stable test --workspace --all-features` | **276 passing**, 0 failed, 0 ignored, 0 warnings |
