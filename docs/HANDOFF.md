...
- **State:** 271 tests passing (152 subset-lib + 70 vc + 43 integration + 6 driver-bin),
...
| Lane | Status |
|---|---|
| `cargo +stable test --workspace --all-features` | **271 passing**, 0 failed, 0 ignored, 0 warnings |
