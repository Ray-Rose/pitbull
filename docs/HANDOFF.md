...
- **State:** 270 tests passing (152 subset-lib + 70 vc + 42 integration + 6 driver-bin),
...
| Lane | Status |
|---|---|
| `cargo +stable test --workspace --all-features` | **270 passing**, 0 failed, 0 ignored, 0 warnings |
