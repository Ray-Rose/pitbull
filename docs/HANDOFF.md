...
- **State:** 266 tests passing (150 subset-lib + 70 vc + 41 integration + 5 driver-bin),
...
| Lane | Status |
|---|---|
| `cargo +stable test --workspace --all-features` | **266 passing**, 0 failed, 0 ignored, 0 warnings |
