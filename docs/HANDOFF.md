...
- **State:** 262 tests passing (150 subset-lib + 70 vc + 41 integration + 1 cargo-pitbull bin),
...
| Lane | Status |
|---|---|
| `cargo +stable test --workspace --all-features` | **262 passing**, 0 failed, 0 ignored, 0 warnings |
